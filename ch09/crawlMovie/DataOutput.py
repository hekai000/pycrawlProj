...
class DataOutput(object):
    ...
    def output_db(self, table_name):
        for data in self.datas:
            self.cx.execute("INSERT INTO %s (MovieId,MovieTitle,RatingFinal,ROtherFinal,RPictureFinal,RDirectorFinal,RStoryFinal,Usercount,AttitudeCount,\
                            TotalBoxOffice,TodayBoxOffice,Rank,ShowDays,isRelease) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?);" % table_name, data)
